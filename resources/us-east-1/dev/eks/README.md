...
prepends `<org>-<env>-`, so `ng/dev-ng-system-od-us-east-1.yaml` with
`name: ng-system-od-us-east-1` becomes `u25c-dev-ng-system-od-us-east-1`.

| Group | Profile | Purpose |
| --- | --- | --- |
| `ng-system-od-us-east-1` | t3.medium, on-demand, 1/2/3 | kube-system / cluster-critical |
...
| `ng-istio-od-us-east-1` | t3.medium, label only | istiod + ingress gateways |
