...
| `ssh_public_key` | the team's **public** key; Terraform creates the key pair named `name` from it. The private half lives in SSM Parameter Store `/dev/bastion/ssh-private-key` |
